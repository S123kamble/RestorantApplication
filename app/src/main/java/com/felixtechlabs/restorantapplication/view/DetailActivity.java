...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuList.add(new Menu("sandwich","panir sandwich 260","http://i.imgur.com/DvpvklR.png","5","Dessert",200,0,0,true,false));
        menuList.add(new Menu("sandwich","vege sandwich 200","http://i.imgur.com/DvpvklR.png","6","Main",150,0,0,true,true));
        menuList.add(new Menu("Brade","bradjam 160","http://i.imgur.com/DvpvklR.png","7","Dessert",160,0,0,true,false));
        menuList.add(new Menu("Brade","bradbutter 120","http://i.imgur.com/DvpvklR.png","8","Main",260,0,0,true,true));
        menuList.add(new Menu("poha","poha 110","http://i.imgur.com/DvpvklR.png","9","Starter",110,0,0,true,false));
        menuList.add(new Menu("dosa","dosa 160","https://api.androidhive.info/images/glide/medium/deadpool.jpg","10","Dessert",100,0, 0,true,true));
        menuList.add(new Menu("idli","idli 120","https://api.androidhive.info/images/glide/medium/deadpool.jpg","11","Main",100,0,0,true,false));
